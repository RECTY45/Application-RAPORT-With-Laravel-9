        ...
        <div class="row mb-2">
            <div class="col-md-12">
                <span>
                    ...
                    <p class="h2">Tambah Data Jurusan</p>
                </span>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input value="{{ $item->nama_jurusan }}" type="text" name="nama_jurusan" class="form-control @error('nama_jurusan')is-invalid @enderror" placeholder="Masukkan Nama Jurusan">
                        @error('nama_jurusan')
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select value="{{ $item->kode_jurusan }}" name="kode_jurusan" class="form-control @error('kode_jurusan')is-invalid @enderror">
                            @if ($item->kode_jurusan)
                                <option selected value="{{ $item->kode_jurusan }}">{{ $item->kode_jurusan }}</option>
                            @endif
