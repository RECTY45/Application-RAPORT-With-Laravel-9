                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input  value="{{ $item->nama_kelas }}" type="text" name="nama_kelas" class="form-control @error('nama_kelas')is-invalid @enderror">
                                        @error('nama_kelas')
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Level</label>
                                        <select value="{{ $item->level }}" name="id_kelas" class="form-control">
